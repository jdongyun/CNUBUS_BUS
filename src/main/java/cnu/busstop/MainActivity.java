...
public class MainActivity extends AppCompatActivity {
    ...
    String LOG_TAG = "CNUBUS";
    String post_key = "xfjNb4WqiOPVLdR";
        ...
        if (pref.getString("busStyle", "NULL").equals("NULL")) { //처음 실행시 버스종류 지정이 안됐을 때
            ...
            if (pref.getString("busStyle", "NULL").equals("X")) { //버스가 운행중이 아닐 때
                        ...
                        client.newCall(request).enqueue(new Callback() {
                            ...
                            public void onResponse(Call call, final Response response) throws IOException {
                                ...
                                try {
                                    ...
                                    Log.i(LOG_TAG, "SendTime is " + json.getInt("time"));
                ...
                try {
                    ...
                    Toast.makeText(this, "위치 권한이 없습니다. 설정해 주세요.", Toast.LENGTH_SHORT).show();
                }
        ...
        public void onLocationChanged(Location location) {
            ...
            if (longitude != null) {
                ...
                if (location.getProvider().equals(LocationManager.GPS_PROVIDER)) {
                    ...
                    tvGPSProvider.setTextColor(ContextCompat.getColor(getApplicationContext(), android.R.color.black));
                } else {
                    tvGPSProvider.setText("GPS에 연결되지 않았습니다.\n네트워크 기반 위치를 사용합니다.");
                    tvGPSProvider.setTextColor(ContextCompat.getColor(getApplicationContext(), android.R.color.holo_red_dark));
                }
            }
        }
